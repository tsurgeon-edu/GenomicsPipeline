...
folde_list.extend([("/media/bioinformaticslab/369ca485-b3f2-4f04-bbfb-8657aad7669e/bioinformaticslab/Desktop/AMBRY/203/Sample_NB"+str(a) + "/Novoalign/PreProcess", "NB"+str(a), "Novoalign", "SomaticSniper", "GATK4_MDUP_Novoalign_NB"+str(a) + "_MergedBAM.bam") for a in range(27, 33, 1)])
